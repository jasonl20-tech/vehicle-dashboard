...
import {
  ...
  type MediaFieldVariant,
  newMediaFieldFromWizard,
...
export default function AddMediaFieldModal({
  open,
  suggestedName,
  suggestedId,
  onClose,
  ...
  const [variant, setVariant] = useState<MediaFieldVariant>("one");
  ...
  function submit() {
    ...
    onAddAndConfigure(
      newMediaFieldFromWizard({ id: fid, name: n, variant }),
    );
  }
          ...
          <div className="mt-6 space-y-4">
            ...
            <label className="flex cursor-pointer gap-3 rounded-lg border border-transparent p-1 hover:bg-[#f8f9fa]">
              ...
              <span>
                ...
                <span className="mt-0.5 block text-[12px] leading-snug text-[#5f6368]">
                  For example several photos, PDF files, etc. API response will
