...
export default function AddJsonObjectFieldModal({
  open,
  suggestedName,
  suggestedId,
  onClose,
  ...
  function submit() {
    ...
    onAddAndConfigure(newJsonObjectFieldFromWizard({ id: fid, name: n }));
  }
  ...
  return (
    ...
    >
      <button
        ...
        onClick={onClose}
      />
      <div className="relative max-h-[min(92vh,560px)] w-full max-w-[640px] overflow-hidden rounded-lg border border-[#dadce0] bg-white shadow-2xl">
        <header className="flex items-center justify-between border-b border-[#dadce0] px-5 py-4">
          <h2 className="text-[15px] font-semibold text-[#1a1a1a]">
            Add field · JSON object
          </h2>
          <button
            type="button"
            onClick={onClose}
