...
export default function TextFieldModal({
  ...
  const typeLabel = `${FIELD_TYPE_LABELS.Text} (${variantLabel})`;
  ...
  return (
    ...
    >
      ...
      >
        <div>
          ...
          <div className="mb-4 rounded-lg border border-[#f9ab00]/50 bg-[#fef7e0]/80 px-3 py-2 text-[11px] text-[#663c00]">
            Type and list settings were set when the field was created and
            cannot be changed here ({variantLabel}
            {field.list ? ", List" : ""}).
          </div>
      ...
      <section id={cmsFieldSectionDomId("validation")} className="scroll-mt-6">
        <h3 className="mb-2 text-[20px] font-semibold text-[#1a1a1a]">
          Validation
        </h3>
            ...
            local.allowedValuesEnabled ? (
              <div className="mt-3 ml-7">
                <textarea
                  ...
                  className="w-full max-w-md rounded-md border border-[#dadce0] px-2 py-1.5 text-[12px]"
                />
              </div>
            ) : null,
          )}
      ...
      <section id={cmsFieldSectionDomId("default")} className="scroll-mt-6">
        ...
        <div className="mb-4 flex gap-3 rounded-lg border border-[#aecbfa] bg-[#e8f0fe] p-4">
          ...
          <p className="text-[12px] leading-relaxed text-[#1967d2]">
            This value is inserted automatically when creating a new entry
            (schema only; entry editor may use it later).
          </p>
        </div>
        <input
