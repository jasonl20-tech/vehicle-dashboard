      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="max-width:600px;background:#ffffff;border-radius:8px;">
        <tr><td style="padding:32px;">
          ...
          <p style="margin:24px 0 0 0;">
            <a href="https://vehicleimagery.com" style="display:inline-block;background:#0f0f10;color:#ffffff;text-decoration:none;padding:10px 20px;border-radius:6px;font-size:13px;">Aktion ausführen</a>
          </p>
        </td></tr>
      </table>
    </td>
